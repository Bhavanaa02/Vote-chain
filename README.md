# vote-chain-blockchain-based-electronic-voting-system
...
3. Configure metamask on the browser with the following details
   ...
   New RPC URL: `http://127.0.0.1:8545` *(use `port: 8545` for **ganache gui**, update it in the file:`truffle-config.js` as well)*
